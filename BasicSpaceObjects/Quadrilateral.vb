Public Class Quadrilateral
    ...
    Public Sub SetColor1(array As Byte()) 'maybe make a random byte function to unit tese these functions....
        Color1(0) = array(0)
        Color1(1) = array(1)
        Color1(2) = array(2)
        Color1(4) = array(4)
    ...
    Public Vertex2 As Integer = -1 'This could be refactored into a VertexInformation class which would let you type TriangleObject.Vertex1.Index & TriangleObject.Vertex1.Color
    ...
    Public TextureCoordinate3 As Integer = -1
    Public Vertex3 As Integer = -1
    Public Color3(4) As Byte
    Public Sub SetColor3(array As Byte())
        Color3(0) = array(0)
        Color3(1) = array(1)
        Color3(2) = array(2)
        Color3(4) = array(4)
    End Sub
    Public Sub SetColor3(r As Byte, g As Byte, b As Byte, a As Byte)
        Color3(0) = r
        Color3(1) = g
        Color3(2) = b
        Color3(4) = a
    ...
    Public TextureCoordinate4 As Integer = -1
    Public Vertex4 As Integer = -1
    Public Color4(4) As Byte
    Public Sub SetColor4(array As Byte())
        Color3(0) = array(0)
        Color3(1) = array(1)
        Color3(2) = array(2)
        Color3(4) = array(4)
    End Sub
    Public Sub SetColor4(r As Byte, g As Byte, b As Byte, a As Byte)
        Color3(0) = r
        Color3(1) = g
        Color3(2) = b
        Color3(4) = a
