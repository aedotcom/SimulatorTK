...
namespace Geometry
{
    //this class has a float [3, 4] matrix, but is calculated in such a way as to assume there is always a 4th row [0 0 0 1]
    public class Matrix3H4 : IMatrix3H4
    {
        #region Constructors
        public Matrix3H4()
        {
        ...
        public Matrix3H4(float[,] array) //array copy constructor //assumes exactly 4x4 array,, hmm....
        {
            Data = new float[3, 4];
            this.Copy(array);
        }
        ...
        //[MethodImpl(MethodImplOptions.AggressiveInlining)] //may not work in .NET 4.0
        public void SetColumn(int col, Vector3H1 V)
        {
            Data[0, col] = V.X;
            Data[1, col] = V.Y;
            Data[2, col] = V.Z;
        ...
        public void setDiagonal(float d0, float d1, float d2)
        {
            Data[0, 0] = d0;
            Data[1, 1] = d1;
            Data[2, 2] = d2;
        ...
        //Sadly, operators must be static & static methods can  not be inherited or specified in an interface
        //and extension methods cannot be given an operator name
        #region Math Operators
        public static bool operator ==(Matrix3H4 m1, Matrix3H4 m2)
        {
        ...
        public static bool operator ==(Matrix3H4 m1, Matrix3X3 m2)
        {
            // If one is null, but not both, return false.
            if (((object)m1 == null) ^ ((object)m2 == null))
            {
        ...
        public static bool operator ==(Matrix3X3 m1, Matrix3H4 m2)
        {
            // If one is null, but not both, return false.
            if (((object)m1 == null) ^ ((object)m2 == null))
            {
