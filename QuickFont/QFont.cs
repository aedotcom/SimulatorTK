...
namespace QuickFont
{
    public class QFont : IDisposable
    {
        ...
        //You would think these Measure functions would be static = but they actually have to be instance methods
        //because the size of text on the screen will depend on the font you use
